...
model.setInputParams(size=(416, 416), scale=1/255, swapRB=True,crop= False)# để size phải kiểu yolov4 tiny normalnize 1/255 , chuyển qua RGB vì opencv đọc BGR

img_path = '../test_file/images/images (2).jpg'
...
cv2.imwrite("detect_images_file/images (2).jpg", frame)
